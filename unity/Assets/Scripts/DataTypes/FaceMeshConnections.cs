...
namespace Assets.Scripts.DataTypes.FaceMesh
{
    ...
    {
        public static readonly HashSet<(int, int)> FACEMESH_LIPS = new HashSet<(int, int)>
        {
        ...
        public static readonly HashSet<(int, int)> FACEMESH_LEFT_EYE = new HashSet<(int, int)>
        {
        ...
        public static readonly HashSet<(int, int)> FACEMESH_LEFT_IRIS = new HashSet<(int, int)>
        {
            (474, 475), (475, 476), (476, 477), (477, 474)
        };

        public static readonly HashSet<(int, int)> FACEMESH_LEFT_EYEBROW = new HashSet<(int, int)>
        {
        ...
        public static readonly HashSet<(int, int)> FACEMESH_RIGHT_EYE = new HashSet<(int, int)>
        {
        ...
        public static readonly HashSet<(int, int)> FACEMESH_RIGHT_EYEBROW = new HashSet<(int, int)>
        {
            (46, 53), (53, 52), (52, 65), (65, 55),
            (70, 63), (63, 105), (105, 66), (66, 107)
        };

        public static readonly HashSet<(int, int)> FACEMESH_RIGHT_IRIS = new HashSet<(int, int)>
        {
            (469, 470), (470, 471), (471, 472), (472, 469)
        };

        public static readonly HashSet<(int, int)> FACEMESH_FACE_OVAL = new HashSet<(int, int)>
        {
        ...
        public static readonly HashSet<(int, int)> FACEMESH_NOSE = new HashSet<(int, int)>
        {
            (168, 6), (6, 197), (197, 195), (195, 5),
            (5, 4), (4, 1), (1, 19), (19, 94), (94, 2),
            (98, 97), (97, 2), (2, 326), (326, 327),
            (327, 294), (294, 278), (278, 344), (344, 440),
            (440, 275), (275, 4), (4, 45), (45, 220),
        ...
        public static readonly HashSet<(int, int)> FACEMESH_TESSELATION = new HashSet<(int, int)>
        {
